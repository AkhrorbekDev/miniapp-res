    ...
    <div class="profile-page__content">
      <div class="profile-page__content-header">
        <div class="user-avatar">
          <img
            :src="
              store.getUserAnket?.photo
                ? 'https://miniapp.forkies.ru/' + store.getUserAnket.photo
                : notProfile
            "
            alt="Avatar"
          />
      ...
      <div class="profile-page__content-main">
        ...
        <div class="profile-page__guide">
          <p class="guide-title">Пора в путешествие!</p>
          <p class="guide-description">
            Forkies создан командой Nesin Travel — экспертов по ярким приключениям. У нас более 25
            авторских туров с большим выбором дат. Загляните на сайт и выберите своё следующее
            путешествие!
          </p>
          <a href="https://nesin-travel.com/programs" target="_blank" class="btn btn-light">
            Ознакомиться
          </a>
        </div>
      </div>
