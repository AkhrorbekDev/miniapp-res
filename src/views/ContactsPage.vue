  ...
  <div class="main-container contact-page">
    ...
    <div class="contact-page__content">
      <div class="contact-page__contacts">
        <div @click="showBottomSheet" class="contact-page__contact">
          <img :src="notProfile" alt="">
    ...
    >
      <div class="controls-modal">
        <div class="controls-modal__header">
          ...
          <p class="modal-title">Алёна Иванова</p>
        ...
        <div class="user-socials">
          <a href="instagram.com/alena" class="btn btn-outline-rounded">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <a href="t.me/alena" class="btn btn-outline-rounded">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
