...
<!--          <p class="modal-description1">Журналист</p>-->
        ...
        <div class="user-socials">
          <a v-if="seletedContact.instagram" :href="seletedContact.instagram" target="_blank" class="btn btn-outline-rounded">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
          ...
          <a v-if="seletedContact.telegram" :href="seletedContact.telegram" target="_blank" class="btn btn-outline-rounded">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
